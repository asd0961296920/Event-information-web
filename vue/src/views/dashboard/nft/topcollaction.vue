...
<template>
                    ...
                    <div class="card-header d-flex align-items-center">
                        ...
                        <b-link href="/apps/nft-collection" type="button"
                    ...
                    <div class="card-body">
                        <div class="swiper collection-slider">
                            <div class="swiper-wrapper">
                                <swiper class="swiper responsive-swiper rounded gallery-light pb-4" :loop="true" :slidesPerView="1" :spaceBetween="10">
                                <swiper-slide>
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <b-link href="/apps/nft-creators" type="button"
                            class="btn btn-soft-primary btn-sm flex-shrink-0">
                            See All <i class="ri-arrow-right-line align-bottom"></i>
                        </b-link>
                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3 flex-grow-1">
                                            ...
                                            <p class="text-muted mb-0"><i
                                                    class="mdi mdi-ethereum text-primary fs-14"></i> 81,369 ETH</p>
                                        </div>
                                        <div>
                                ...
                                <swiper-slide>
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3 flex-grow-1">
                                            ...
                                            <p class="text-muted mb-0"><i
                                                    class="mdi mdi-ethereum text-primary fs-14"></i> 68,945 ETH</p>
                                        </div>
                                        <div>
                                            <div class="dropdown float-end">
                                                <button class="btn btn-ghost-primary btn-icon dropdown" type="button"
                                ...
                                <swiper-slide>
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3 flex-grow-1">
                                            ...
                                            <p class="text-muted mb-0"><i
                                                    class="mdi mdi-ethereum text-primary fs-14"></i> 49,031 ETH</p>
                                        </div>
                                        <div>
                                            <div class="dropdown float-end">
                                                <button class="btn btn-ghost-primary btn-icon dropdown" type="button"
